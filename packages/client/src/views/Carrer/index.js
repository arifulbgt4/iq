  ...
  return (
    <Container className="carrer mb-5">
      ...
      <CarrerItem img={image3} title="Ethics and Work Culture" id={3}>
        Whether you're the CEO or a Summer intern, we value your opinions and
        ideas just the same! Polls are conducted regularly to ensure everyone's
        voice is heard
      </CarrerItem>
      <CarrerItem img={image4} title="Equality" id={4}>
        Take off the masks you wear to avoid discrimination and judgement. We're
        focused on creating a healthy work environment
      </CarrerItem>
      <CarrerItem img={image5} title="Team Spirit" id={5}>
        No high school cliques here, we're that big sappy family you see on the
        default pictures in photo frames
      </CarrerItem>
      <Apply />
    </Container>
  );
